vim.api.nvim_create_autocmd('PackChanged', {
    callback = function(ev)
        ...
        if name == 'telescope-fzf-native.nvim' and (kind == 'install' or kind == 'update') then
            vim.system({ 'make' }, { cwd = vim.pack.get({ "telescope-fzf-native.nvim" })[1].path })
        end
    end
})
...
vim.pack.add({
    ...
    'https://github.com/nvim-telescope/telescope-fzf-native.nvim', -- build = 'make', cond = vim.fn.executable 'make' == 1
